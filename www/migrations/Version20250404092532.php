 ...
 */
final class Version20250404092532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE device (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(50) NOT NULL, type VARCHAR(50) NOT NULL, is_active TINYINT(1) NOT NULL, reference VARCHAR(50) NOT NULL, brand VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE setting_data (id INT AUTO_INCREMENT NOT NULL, setting_type_id INT NOT NULL, vibe_id INT NOT NULL, data VARCHAR(25) NOT NULL, INDEX IDX_6C47DF859D1E3C7B (setting_type_id), INDEX IDX_6C47DF854B255BC3 (vibe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE image ADD category INT NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE image DROP category
        SQL);
    }
}
